import styles from './NESChart.module.scss';
...
interface NESChartProps {
  times: [Dayjs, Dayjs];
  mode: string;
}

function NESChart({ times, mode }: NESChartProps) {
  ...
  const chartOption: EChartsOption = useMemo(() => {
    ...
    const seriesData = data.map((item) => item.nes);
...
export default observer(NESChart);
